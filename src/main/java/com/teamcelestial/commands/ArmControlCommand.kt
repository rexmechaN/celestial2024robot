...
private val armPreset = ArmPresetData(
    defaultTheta = 80.0, //TODO: The default theta, target angle when robot starts
    absZeroPointDegrees = 0.104 * 360.0 //TODO: The absolute zero point of the arm in degrees. Must be parallel to ground.
)
